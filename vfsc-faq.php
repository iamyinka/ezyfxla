...
<section class="why-us">
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <h1><i class="fa fa-question-circle"></i>VFSC FAQ</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
          <div class="panel-body">
            The Dealers in Securities (Licensing) Act [CAP 70] allows for the regulation and oversight of forex trading in Vanuatu.
          </div>
        </div>
      </div>
