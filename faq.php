...
<section class="reg-start vscf-faq">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-12 faq-intro">
        <h4 class="text-center">Frequently Asked Questions</h4>

        <p>Our awesome support agents are on call for you virtually around the clock, so you're never
more than a mouse-click away from enjoying the EZYFX experience to the fullest.</p>

        <p>As a way of introducing what EZYFX is all about, we've put together a collection of our most
frequently asked questions. Feel free to browse our FAQ's below and remember anything you
can't find an answer to, our support agents are always there to help you out.</p>
      </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <ul class="nav nav-tabs faq-cat-tabs">
                <li class="active"><a href="#faq-cat-1" data-toggle="tab">Opening An Account</a></li>
                <li><a href="#faq-cat-2" data-toggle="tab">Dashboard</a></li>
                <li><a href="#faq-cat-3" data-toggle="tab">Trading</a></li>
                <li><a href="#faq-cat-4" data-toggle="tab">Platform</a></li>
                <li><a href="#faq-cat-5" data-toggle="tab">Metatrader 4</a></li>
                <li><a href="#faq-cat-6" data-toggle="tab">Regulation</a></li>
                <li><a href="#faq-cat-7" data-toggle="tab">Your Money</a></li>
            </ul>
  ...
  Withdrawals are usually processed within 48 hours. Funds are typically sent back to the original source, meaning, if you deposit through Credit Card, funds will be sent back to the same Credit Card.
                ...
                <div class="tab-pane fade" id="faq-cat-7">
                    <div class="panel-group" id="accordion-cat-7">
                        <div class="panel panel-default panel-faq">
                            <div class="panel-heading">
                                <a data-toggle="collapse" data-parent="#accordion-cat-7" href="#faq-cat-7-sub-1">
                                    <h4 class="panel-title">
                                        FAQ Item Category #7
                                        <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                                    </h4>
                            ...
                            <div id="faq-cat-7-sub-1" class="panel-collapse collapse">
                                <div class="panel-body">
                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default panel-faq">
                            <div class="panel-heading">
                                <a data-toggle="collapse" data-parent="#accordion-cat-7" href="#faq-cat-7-sub-2">
                                    <h4 class="panel-title">
                                        FAQ Item Category #7
                                        <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                                    </h4>
                            ...
                            <div id="faq-cat-7-sub-2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                </div>
                            </div>
