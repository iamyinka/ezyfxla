...
<!-- <section class="vision-hero">
  <div class="container">
    <div class="hero-text">
      ...
      <p class="text-center"><small>To Help Maximize The Value Of Our Client’s <a href="#" class="btn-link">Financial Needs</a></small></p>
    </div>
  </div>
</section> -->
...
<!-- <section class="mission">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">Our Mission :: <br> <small class="btn-link">Your Wealth is Our Health</small></h2>
      </div>
    </div>
