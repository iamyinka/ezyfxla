...
<section class="why-us">
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <h1><i class="fa fa-fire"></i>HOT Bonus</h1>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-6">
        <h6>Step 1. Register a real trading account</h6>
        <div class="row">
          <div class="col-xs-2">
            <div class="steps">
      ...
      <div class="col-xs-12 col-sm-6">
        <h6>Step 2. Apply for the 120% Hot Bonus</h6>
        <div class="row">
          <div class="col-xs-2">
            <div class="steps">
          ...
          <div class="col-xs-10">
            <p>After registering a real account, please choose “Bonuses” tab on the left hand-side menu and select the 120% Hot Bonus. At the bottom of the page click the “Get the 120% Hot Bonus” button.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <p>In order to get the bonus, you should activate your trading account by replenishing it with any amount. You can replenish it using whatever method is more convenient for you. The amount of the deposit is also specified by you.</p>
          </div>
        </div>
      </div>

      <div class="col-xs-12 col-sm-6">
        <h6>Step 4. Get 120% Hot Bonus to your trading account</h6>
        <div class="row">
          <div class="col-xs-2">
            <div class="steps">
          ...
          <div class="col-xs-10">
            <p>The 120% Hot Bonus will be automatically credited to your account.</p>
          </div>
        </div>
      </div>
    </div>
